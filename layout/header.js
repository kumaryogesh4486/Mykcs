...
function Header() {
    ...
    return (
      <>
        {/* <!-- Header --> */}
        <header className="site-header  text-black mo-left" id="fix-header">
            {/* <!-- Main Header --> */}
            <div className="sticky-header main-bar-wraper navbar-expand-lg">
                <div className="main-bar clearfix ">
                    <div className="container clearfix">
                        {/* <!-- Website Logo --> */}
                        <div className="logo-header mostion logo">
                        ...
                        <div className={`header-nav navbar-collapse collapse justify-content-end ${show ? "show" : ""}`} id="navbarNavDropdown">
                            ...
                            <div className="extra-cell">
                                ...
                                <ul>
                                    <Link href="https://facebook.com/"><a className="fa fa-facebook"></a></Link>
